...
BOT_VERSION = "v10.1 DANGER MARKET SCORE CAP"
...
def help_text():
    return (
        ...
        "📰 Новости: ФРС/геополитика/крипто обновляются по RSS-заголовкам каждые 15 минут\n🧠 v9.6: deal/ceasefire/end war/reopen Hormuz считаются деэскалацией, слабые источники получают меньший вес; v10.1: опасный рынок ограничивает BTC/ETH/альты по score и убирает формулировки про набор/первую часть"
    )
