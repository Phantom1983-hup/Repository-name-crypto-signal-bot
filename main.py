...
BOT_VERSION = "v9.8 CLEAN MARKET SUMMARY"
...
def help_text():
    return (
        ...
        "📰 Новости: ФРС/геополитика/крипто обновляются по RSS-заголовкам каждые 15 минут\n🧠 v9.6: deal/ceasefire/end war/reopen Hormuz считаются деэскалацией, слабые источники получают меньший вес; v9.8: /market короткий — только статус, причины, решение и что ждём"
    )
