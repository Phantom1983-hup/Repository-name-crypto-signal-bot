...
BOT_VERSION = "v11.3 EMERGENCY QUEUE FIX"
...
def help_text():
    return (
        ...
        "/storage, /backup, /weekday, /flush, /admin_update, /rollback\n"
        ...
        "📰 Новости: ФРС/геополитика/крипто обновляются по RSS-заголовкам каждые 15 минут\n🧠 v9.6: deal/ceasefire/end war/reopen Hormuz считаются деэскалацией, слабые источники получают меньший вес; v11.3: emergency queue fix — старые /signal после redeploy пропускаются, offset Telegram сохраняется"
    )
