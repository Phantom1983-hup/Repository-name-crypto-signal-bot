...
BOT_VERSION = "v9.9 CLEAN SIGNAL WORDING"
...
def help_text():
    return (
        ...
        "📰 Новости: ФРС/геополитика/крипто обновляются по RSS-заголовкам каждые 15 минут\n🧠 v9.6: deal/ceasefire/end war/reopen Hormuz считаются деэскалацией, слабые источники получают меньший вес; v9.9: /signal очищен — Новости отдельно, риск рынка отдельно, без слова «лучшие идеи» в опасном рынке"
    )
