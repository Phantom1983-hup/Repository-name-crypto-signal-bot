...
BOT_VERSION = "v10.6 SAFE CAUTION BORDER FIX"
...
def help_text():
    return (
        ...
        "📰 Новости: ФРС/геополитика/крипто обновляются по RSS-заголовкам каждые 15 минут\n🧠 v9.6: deal/ceasefire/end war/reopen Hormuz считаются деэскалацией, слабые источники получают меньший вес; v10.6: safe-caution при страхе 14–15 и BTC около -1.8…-2.0%; без среднесрока/первой части, альты cap 65–68"
    )
