...
BOT_VERSION = "v5.7.1 CONSISTENCY FIX"
...
def worth_it_text(c):
    ...
    # Главный фикс: если итоговый вердикт не BUY, блок risk/reward не должен писать "🟢 Да".
    if "НЕТ СИГНАЛА" in verdict_text:
        verdict = "🟡 Пока рано"
        text = "Теоретический потенциал есть, но вход ещё не сформирован."
    elif "НЕ ПОКУПАТЬ" in verdict_text:
        verdict = "🔴 Нет"
        text = "Даже если риск небольшой, качественного входа сейчас нет."
    elif high <= 0:
        verdict = "🔴 Нет"
