...
BOT_VERSION = "v10.0 SINGLE COIN DANGER WATCH FIX"
...
def help_text():
    return (
        ...
        "📰 Новости: ФРС/геополитика/крипто обновляются по RSS-заголовкам каждые 15 минут\n🧠 v9.6: deal/ceasefire/end war/reopen Hormuz считаются деэскалацией, слабые источники получают меньший вес; v10.0: качественные альты в опасном рынке не обнуляются до 0/100, а уходят в WATCH без входа"
    )
