...
BOT_VERSION = "v3.4 FINAL PROBABILITY FIX"
...
def alex_edge_ultra(symbol):
    ...
    if action == "BUY" and change_24 < 8:
        ...
        entry_zone = "вход уже поздний: лучше ждать откат или новый объём"
    elif action == "WATCH":
...
def get_signal():
    try:
        ...
        if pumps:
            text += "🟠 ПРОДОЛЖЕНИЕ ТРЕНДА / РИСКОВАННЫЕ ИМПУЛЬСЫ:\n\n"
