...
BOT_VERSION = "v8.4 BTC CORE ASSET FIX"
...
def human_final(c):
    ...
    if "СРЕДНЕСРОЧНЫЙ" in c["verdict"]:
        return "только малая первая часть, без входа всей суммой."
...
def format_single_coin_report(c):
    ...
    if c.get("_btc_core_watch"):
        ...
        text += "Итог: идея только для частичного набора, без входа всей суммой."
...
def help_text():
    return (
        ...
        "🟡 НАБЛЮДАТЬ — пока не покупать\n🟦 СРЕДНЕСРОЧНЫЙ НАБОР — при падении ждать стабилизацию, вход только малой частью\n"
