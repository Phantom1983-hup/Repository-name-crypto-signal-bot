...
BOT_VERSION = "v2.5 FIXED INDENTS"
...
QUALITY_ASSETS = [
    "BTC", "ETH", "SOL", "TON", "GRAM", "SUI", "XRP", "ADA", "LINK",
    "AVAX", "NEAR", "TAO", "INJ", "RNDR", "FET", "AAVE", "BNB",
    "DOT", "LTC", "APT", "ARB", "OP", "SEI", "ATOM", "FIL", "TRX"
]

FORCE_ANALYZE_ASSETS = [
    "TON-USDT", "SOL-USDT", "TAO-USDT", "SUI-USDT", "ETH-USDT", "BTC-USDT"
]
...
def alex_edge_ultra(symbol):
    ...
    elif 12 < change_24 <= 18:
        score -= 10
        minus.append("рост уже заметный, вход становится рискованнее")
    elif 18 < change_24 <= 25:
        score -= 18
        minus.append("монета уже сильно выросла, риск отката повышен")
    elif 25 < change_24 <= 35:
        score -= 30
        minus.append("монета близко к позднему пампу")
    elif change_24 > 35:
        score -= 45
        minus.append("поздний памп, риск резкого отката высокий")
    elif change_24 < -5:
        score -= 10
    ...
    if 2 < change_24 < 12 and d["move_1h"] > 1.5 and d["vol_1h"] > 1.3:
        score += 14
        plus.append("🔥 начинается сильный разгон")
        ...
        try:
            ...
            for item in updates.get("result", []):
                ...
                if text == "/start":
                    ...
                    send_message(
                        chat_id,
                        text_alert if text_alert else f"Версия: {BOT_VERSION}\nСейчас быстрых памп-сигналов нет."
                    )
