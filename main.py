...
BOT_VERSION = "v8.9 INTERFACE + COIN SEARCH"
...
def coin_search_prompt():
    return (
        "🔎 Поиск монеты\n\n"
        "Напиши тикер монеты обычным сообщением.\n\n"
        "Примеры:\n"
        "BTC\n"
        "ETH\n"
        "SOL\n"
...
def help_text():
    return (
        ...
        "Главные кнопки:\n"
        "📊 Сигнал — общий отчёт\n"
        "🔎 Монета — поиск любой монеты по тикеру\n"
        ...
        try:
            ...
            for item in updates.get("result", []):
                ...
                if raw_text in SEARCH_BUTTONS:
                    ...
                    send_message(chat_id, coin_search_prompt())
                    continue
                ...
                if text == "/start":
                    send_message(chat_id, "✅ Бот работает\nНижнее меню обновлено и стало удобнее.\n\n" + help_text())
