...
BOT_VERSION = "v3.0 FINAL BALANCED"
...
def alex_edge_ultra(symbol):
    ...
    if change_24 >= 25:
        ...
        action = "BUY"
    elif strong_continuation and chance_5 >= 40 and high >= 5:
        if d["vol_1h"] >= 1.0 or score >= 70:
            verdict = "🟢 СИЛЬНЫЙ ТРЕНД"
            action = "BUY"
        else:
