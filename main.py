...
def compact_signal_report(ctx, buy, accum, watch, aggressive, speculative, early_text, speculative_watch, late_pumps):
    text = (
    ...
    text += compact_late_pumps(late_pumps)
    text += compact_learning_text()
    text += "\nПодробно по монете: /btc или /sol"
